  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Missed Employees</li>
      ...
      <div class="card mb-3">
        <div class="card-header">
          ...
          <div class="row">
            <div class="col-2">
              <i class="fa fa-table"></i> <b>Missed   attendance </b>
            </div>
            <div class="col-2">
            ...
            <div class="col-2">
              <label style="font-weight: bolder;" for="#to_ddate"> <u>To</u>&nbsp;&nbsp;&nbsp;&nbsp;(Date): </label>
              <input type="date" id="to_ddate" class="form-control" name="">
            </div>
            <div class="col-2"> 
            ...
            <div class="col-2">
              <button style="float:right;margin-top: 20px;"  id="srch_att_missed" class="btn btn-success">Search</button>
            </div>
            <div class="col-2">
        ...
        <div class="card-body">
          <div class="table-responsive"  id="resspp"> 
...
function ExportToExcel(type, fn, dl) {
       ...
       return dl ?
         ...
         XLSX.writeFile(wb, fn || ('AttendanceMissedAttendance.' + (type || 'xlsx')));
    }
</script>
  </div>
</body>
