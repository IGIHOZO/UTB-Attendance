...
if (@$_SESSION['utb_att_position']!='Reception') {
  ?>
...
@keyframes rainbow-animation {
    to {
        ...
        <script type="text/javascript">
            ...
            function downloadimage(htmltoimage,name,phTypee,ellement) {
              var ptType = '';
              if (phTypee==='card') {
                ptType = 'CARD';
              }else{
                ...
                html2canvas(container, { allowTaint: true }).then(function (canvas) {
                    ...
                    link.download = ptType+"_"+name+".jpg";
    ...
    <div class="container-fluid">
      ...
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-area-chart"></i> <input type="text" class="form-control" placeholder="Enter Your ID to Print" id="print_card"></div>
...
var input = document.getElementById("print_card");
var contenttt = document.getElementById('print_card').value;
...
input.addEventListener("keypress", function(event) {
  ...
  if (event.key === "Enter") {
    ...
    // Trigger the button element with a click
      ...
      type:"GET",data:{
        print_card:print_card,contenttt:document.getElementById('print_card').value
      },cache:false,success:function(res){
        if (res=='not_found') {
          $("#respp").html("<h3>User ID Not found ...</h3>");
        }else{
          $("#respp").html(res);
